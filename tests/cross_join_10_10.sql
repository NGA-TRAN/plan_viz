ProjectionExec: expr=[l_key@0 as l_key, r_key@1 as r_key]
  CrossJoinExec
    CoalescePartitionsExec
      DataSourceExec: file_groups={10 groups: [[l1.parquet], [l2.parquet], [l3.parquet], [l4.parquet], [l5.parquet], [l6.parquet], [l7.parquet], [l8.parquet], [l9.parquet], [l10.parquet]]}, projection=[l_key], file_type=parquet
    CoalescePartitionsExec
